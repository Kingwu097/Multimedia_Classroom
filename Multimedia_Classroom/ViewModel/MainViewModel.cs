...
using Multimedia_Classroom.Common;
using Multimedia_Classroom.Model;

namespace Multimedia_Classroom.ViewModel
{
    public class MainViewModel : NotifyBase
    {
        ...
        {
            Type type = Type.GetType("Multimedia_Classroom.View." + obj.ToString());
